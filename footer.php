        ...
        <div class="row">
            ...
            <div class="footer_widget">
              ...
              <ul class="special_widget">
                ...
                <li>
                  ...
                  <a target="_blank" href="#">Lorem ipsum dolor sit amet, Maringá - PR, 00000-000</a>
                </li>
              </ul>
            </div>
          </div>
          <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="footer_widget">
              <h4>Minha Conta</h4>
              <ul>
                <li><a href="minhaconta.php"><i class="fa fa-angle-right"></i>Minha Conta</a></li>
                <li><a href="pedidos.php"><i class="fa fa-angle-right"></i>Meus Pedidos</a></li>
              </ul>
            </div>
          </div>
          <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="footer_widget">
              <h4>Institucional</h4>
              <ul>
                <li><a href="sobre.php"><i class="fa fa-angle-right"></i>Sobre Nós</a></li>
                <li><a href="faq.php"><i class="fa fa-angle-right"></i>Dúvidas Frequentes</a></li>
                <li><a href="trocas.php"><i class="fa fa-angle-right"></i>Trocas e Devoluções</a></li>
                <li><a href="prazos.php"><i class="fa fa-angle-right"></i>Prazos</a></li>
                <li><a class="special abrePolitica" href="politicas.php" target="_blank" role="link"><i class="fa fa-angle-right"></i>Política de Privacidade</a></li>
              </ul>
            </div>
          </div>
          <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="footer_widget">
              <h4>Atendimento</h4>
              <ul>
                <li><span class="floatleft"><i class="fa fa-angle-right"></i> Segunda - Sexta das 8.00 AM - 8.00 PM</span></li>
                <li><span class="floatleft"><i class="fa fa-angle-right"></i> Sabado das 8.00 AM - 12.00 PM</span></li>
              </ul>
            </div>
          </div>
        </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 col-sm-6 col-xs-12">
          <span>Copyright © 2017 | Casa do Arquiteto</span>
          <ul id="social-icons">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12 text-right">
          ...
          <a href="http://ltxxdesign.com.br/" target="_blank" id="logoltx">
...
<a href="#" class="scrollup totop" style="display: inline;"><i class="fa fa-long-arrow-up" aria-hidden="true"></i></a>
