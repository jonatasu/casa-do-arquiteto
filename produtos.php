    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                ...
                <div class="clearfix lista-produtos grid-item">
                    <div class="row">
                        <?php for($i=1; $i<=9;$i++){?>
                        <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 product-item">
                            <div class="clearfix item">
                                <div class="product-img">
                                    <a href="produto.php">
												<img src="uploads/produtos/<?=$i?>.jpg" alt="" class="img-responsive center-block">
											</a>
                                </div>
                                <div class="product-info text-center clearfix">
                                    <h6><a href="#">Dummy Product Name</a></h6>
                                    <div class="pro-price">
                                        <a href="#">
                                            <span class="preco">R$12,00 - R$153,00</span>
                                        </a>
                                    </div>
                                    <p><a href="#">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable.</a></p>
                                    <ul class="action-button text-center">
                                        <li>
                                            <button type="submit" class="btn-style1 btn-cart anima">
