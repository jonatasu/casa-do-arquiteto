        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="prod-block">
                        <div class="prod-image">
                            <a href="#"><img src="uploads/produtos/1.jpg" alt="" class="img-responsive"></a>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="prod-block">
                        <div class="prod-image">
                            <a href="#"><img src="uploads/produtos/2.jpg" alt="" class="img-responsive"></a>
                            <a href="#" class="btn-cart"><span class="ti-shopping-cart-full"></span> Adicionar ao Carrinho</a>
                        </div>
                        <div class="prod-desc">
                            <a href="#">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="prod-block">
                        <div class="prod-image">
                            <a href="#"><img src="uploads/produtos/3.jpg" alt="" class="img-responsive"></a>
                            <a href="#" class="btn-cart"><span class="ti-shopping-cart-full"></span> Adicionar ao Carrinho</a>
                        </div>
                        <div class="prod-desc">
                            <a href="#">
